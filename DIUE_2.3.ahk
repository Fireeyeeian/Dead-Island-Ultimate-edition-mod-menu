...
FileInstall, Required_files_and_scripts\Force_bandits_spawn.zip, %A_Temp%\@DIUE_TEMPFILES\loose_files\Force_bandits_spawn.zip,1
...
Gui, Font, CYellow
;;;;;;;;;;;;;;;;;;;;;;;;VERSION NUMBER;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Gui, Add, Text, x750 y64 w100 h30 +BackgroundTrans,Version 2.3
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
SplashTextOff
MsgBox, 4160, Zom_difficulty, ➤Zombies set to Normal (default),
Enable_BUTTONS_Function()
EnableCloseButton(WinExist("DeadIslandUltimateEdition_By_FireEyeEian"))
return
submit_1hit_zom:
...
SplashTextOff
MsgBox, 4160, Zom_difficulty, ➤Zombies set to One-hit mode,
Enable_BUTTONS_Function()
EnableCloseButton(WinExist("DeadIslandUltimateEdition_By_FireEyeEian"))
return
submit_hard_zom:
...
SplashTextOff
MsgBox, 4160, Zom_difficulty, ➤Zombies set to Hard (30`% increase to health,Damage,and stamina multiplier also 60`% decrease to damage influences),
Enable_BUTTONS_Function()
EnableCloseButton(WinExist("DeadIslandUltimateEdition_By_FireEyeEian"))
return
submit_headshot_zom:
...
SplashTextOff
MsgBox, 4160, Zom_difficulty, ➤Zombies set to Headshot only mode,
Enable_BUTTONS_Function()
EnableCloseButton(WinExist("DeadIslandUltimateEdition_By_FireEyeEian"))
return
Submit_zombies_size:
...
DisableCloseButton(WinExist("DeadIslandUltimateEdition_By_FireEyeEian"))
SplashTextOn, 700,105,Writing to file,Please wait.... `n writing to files....`nNOTE: This could take up to 3 minutes, If you have a slow hard drive then your time might vary.`nif you think this is stuck, simply press `"Alt+Del`" on your keyboard or force close the application
TF_ReplaceLine(Def_lev,"104",104,"    <prop n=""BluntWpnDurabilityLoss"" v=""-6.0""/>	<!--  Modified by FireEyeEian-->")
TF_ReplaceLine(Def_lev,"113",113,"    <prop n=""CutWpnDurabilityLoss"" v=""-6.0""/>	<!--  Modified by FireEyeEian-->")
TF_ReplaceLine(Def_lev,"123",123,"    <prop n=""RangedWpnDurabilityLoss"" v=""-6.0""/>	<!--  Modified by FireEyeEian-->")
TF_ReplaceLine(Def_lev,"133",133,"    <prop n=""BulletWpnDurabilityLoss"" v=""-6.0""/>	<!--  Modified by FireEyeEian-->")
SplashTextOff
...
DisableCloseButton(WinExist("DeadIslandUltimateEdition_By_FireEyeEian"))
SplashTextOn, 700,105,Writing to file,Please wait.... `n writing to files....`nNOTE: This could take up to 3 minutes, If you have a slow hard drive then your time might vary.`nif you think this is stuck, simply press `"Alt+Del`" on your keyboard or force close the application
TF_ReplaceLine(Def_lev,"100",100,"	<prop n=""BreakDoorEffectivens"" v=""99""/>	<!--  Modified by FireEyeEian-->")
SplashTextOff
